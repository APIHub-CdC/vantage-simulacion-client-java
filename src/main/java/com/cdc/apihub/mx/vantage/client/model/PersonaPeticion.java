...
import com.cdc.apihub.mx.vantage.client.model.CatalogoEstadoCivil;
import com.cdc.apihub.mx.vantage.client.model.CatalogoResidencia;
import com.cdc.apihub.mx.vantage.client.model.CatalogoSexo;
...
public class PersonaPeticion {
	...
	@ApiModelProperty(example = "1978-03-23", required = true, value = "Fecha de nacimiento de la persona, en el formato especificado (por defecto yyyy-MM-dd)")
